...
class Atri:
	...
	@property
	def introDiv(self):
		self._getter_access_tracker["introDiv"] = {}
		return self._introDiv
	@introDiv.setter
	def introDiv(self, new_state):
		self._setter_access_tracker["introDiv"] = {}
		global default_state
		self._introDiv = Flex(new_state, default_state["introDiv"])
